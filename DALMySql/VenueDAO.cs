...
namespace UFO.DAL.MySql {
    ...
    public class VenueDAO : IVenueDAO {
        ...
        public Venue Create(Venue venue) {
            var cmd = this.CreateInsertCommand(venue.AreaId, venue.Description, venue.ShortDescription, venue.Latitude, venue.Latitude);
        ...
        public Venue Update(Venue venue) {
            var cmd = this.CreateUpdateCommand(venue.Id, venue.AreaId, venue.Description, venue.ShortDescription, venue.Latitude, venue.Latitude);
